    ...
    <div class="page-header">
        <nav class="breadcrumb-one" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="javascript:void(0);">Muhammad Favian Jiwani</a></li>

            </ol>
        </nav>
    </div>
    <div class="row layout-top-spacing" id="cancel-row">
        <div class="widget-content widget-content-area br-6 mr-3">
           <div class="br-6 m-4" style="width: 326px; height: 326px; background-color: bisque;"></div>
           <table class="ml-4 mt-4 mb-4">
            <thead>
                <tr>
                    <th></th>
                    <th></th>
        ...
        <div class="widget-content widget-content-area br-6">
            <table id="zero-config" class="table dt-table-hover" style="width:100%">
                <thead>
                    <tr>
                        <th>Tanggal</th>
                        <th class="no-content dt-no-sorting">Status</th>
