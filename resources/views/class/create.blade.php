...
<div class="layout-px-spacing">
    ...
    <div class="row layout-top-spacing" style="transform: scale(0.9)">
        <div class="widget-content widget-content-area br-6" style="width: 100%;">
            <form action="{{ route("class.insert") }}" class="p-5" method="POST">
                @csrf
                <h3 class="ml-3"></h3>
                <p class="ml-3">Class ID</p>
                <input type="text" name="id" id="" class="form-control m-3" value="" placeholder="ID here">
                <p class="ml-3">Field</p>
                <input type="text" name="field" id="" class="form-control m-3" value="" placeholder="Field here">
                <p class="ml-3">Grade</p>
                <input type="number" name="grade" id="" class="form-control m-3" value="" placeholder="Grade here">
                <p class="ml-3">Name</p>
