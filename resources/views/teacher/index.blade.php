                ...
                <table id="zero-config" class="table dt-table-hover" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $val["name"] }}</td>
                            <td>{{ $val["id"] }}</td>
                            <td>{{ $val["homeroom_class_id"] > 0 ? $class[$val["homeroom_class_id"]] : "*" }}</td>
                            <td class="d-flex">
                                <a href="{{url('teacher/'.$key)}}" class="btn btn-outline-dark"><i class="fas fa-eye"></i></a>
                                <form action="{{ route("teacher.delete", $key) }}" method="POST">
                                    @csrf
