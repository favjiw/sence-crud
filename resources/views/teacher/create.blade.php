...
<div class="layout-px-spacing">
    ...
    <div class="row layout-top-spacing" style="transform: scale(0.9)">
        <div class="widget-content widget-content-area br-6" style="width: 100%;">
            <form action="{{ route("teacher.insert") }}" class="p-5" method="POST">
                @csrf
                <h3 class="ml-3"></h3>
                <p class="ml-3">Teacher ID</p>
                <input type="text" name="student_id" id="" class="form-control m-3" value="" placeholder="ID here">
                <p class="ml-3">Name</p>
                <input type="text" name="name" id="" class="form-control m-3" value="" placeholder="Name here">
                <p class="ml-3">Homeeroom Class ID</p>
                <input type="number" name="homeroom_class_id" id="" class="form-control m-3" value="" min=1 max=8 placeholder="Class ID here">
